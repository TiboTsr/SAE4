...
<main style="max-width: 980px; margin: 0 auto; padding-top: 24px; line-height: 1.6;">
    <h1 style="font-family: 'Koulen', sans-serif; letter-spacing: 3px; font-size: 3rem; margin-bottom: 24px;">
        MENTIONS LEGALES
    </h1>
