...
{
    public static function create(string $name, string $description, float $price, File | null $image, int $reduction): Grade
    {
        $DB = new \DB();
    ...
    public function update(string $name, string $description, float $price, int $reduction): Grade
    {
